...
def contact_us(request):
    ...
    if form.is_valid():
        ...
        account_activation_email = EmailMessage(
            ...
            'Hi admin, a new message is sent to FindREDD.\n\n<Sender Details>:\n\n<Name>: %s \n<Email>: %s \n<Message>: %s \n-------------------\n\nThe FindREDD Trust\n//This is a system generated email "DO-NOT-REPLY-HERE"' % (user_name, user_email, user_message),
            conf_settings.EMAIL_HOST_USER,
            ['info@findredd.in'],
        )
...
def report_issue(request):
    ...
    if form.is_valid():
        ...
        new_issue_email = EmailMessage(
            ...
            'Hi developer, a new issue is reported to FindREDD.\n\n<Reporter Details>:\n\n<Name>: %s \n<Username>: @%s \n<Email>: %s \n-------------------\n\n<Issue Details>: \n\n<Category>: %s \n<Heading>: %s \n<Discription>: %s \n\n====================\n\nThe FindREDD Trust\n//This is a system generated email "DO-NOT-REPLY"' % (reporter_name, reporter_username, reporter_email, issue_category, issue_heading, issue_description),
            conf_settings.EMAIL_HOST_USER,
...
def raise_a_request(request):
    ...
    if form.is_valid():
        ...
        blood_request_email = EmailMessage(
            ...
            'Hi admin, a new blood request is raised to FindREDD.\n\nRequest Details:\n================\n\nPatient name: %s \nFormfiller name: %s \nDistrict: %s \nBlood group required: %s \nUnits required: %s \nMobile number: %s \nAlternate mobile number: %s \nHospital address: %s \n\n====================\n\nThe FindREDD Trust\n//This is a system generated email "DO-NOT-REPLY"' % (patient_name, form_filler_name, district, blood_group_required, units_required, mobile_number, alternate_mobile_number, hospital_address, ),
            conf_settings.EMAIL_HOST_USER,
            ['info@findredd.in', ],
        )
